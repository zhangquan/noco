...
import { commonFns, SqlFunctionBuilder } from './commonFns';

/**
 * PostgreSQL-specific function mappings
 */
export const pgFns: Record<string, SqlFunctionBuilder> = {
 ...
 */
export function getFunction(name: string): SqlFunctionBuilder | undefined {
  const upperName = name.toUpperCase();
  return pgFns[upperName];
}
